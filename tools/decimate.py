...
# **0.10 아니면 1.0 입니다. 그 사이는 오히려 나쁩니다**

적 일곱을 폰 해상도로 재면 이렇습니다.

    원본 2만 + Godot LOD    삼각형 26천   그리기 11~14ms   .scn 580KB
    6천  (0.30)             삼각형 97천                    .scn 180KB
    2천  (0.10)             삼각형 39천   그리기 10~14ms   .scn 112KB
...
그래서 6천은 LOD 가 내려가던 자리(1.5천)보다 네 배 위에 눌러앉아 97천으로
뜁니다. 2천은 그 자리 근처에 떨어져서 그리기 시간이 안 변합니다 - 대신 파일이
5분의 1 이 됩니다.

**중간을 고르지 마세요.** 잃을 것(LOD)은 다 잃고 얻을 것(파일)은 덜 얻습니다.
